...
namespace POSUNO.Web.Data
{
    public class SeedDb
    {
        ...
        private async Task CheckUserAsync()
        {
            ...
            {
                _context.Users.Add(new User { Email = "luis@yopmail.com", FirstName = "Luis", LastName = "Núñez", Password = "123456" });
                _context.Users.Add(new User { Email = "messi@yopmail.com", FirstName = "Lionel", LastName = "Messi", Password = "123456" });
